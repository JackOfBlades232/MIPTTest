...
#define COLLECTABLE_SIZE_X       0.6
#define COLLECTABLE_SIZE_Y       0.6
#define COLLECTABLE_ACCELERATION 4.0
...
STATIC_ASSERT(COLLECTABLE_SIZE_X > 0.0 && COLLECTABLE_SIZE_X < 1.0);
STATIC_ASSERT(COLLECTABLE_SIZE_X > 0.0 && COLLECTABLE_SIZE_X < 1.0);
STATIC_ASSERT(COLLECTABLE_ACCELERATION > 0.0);
